...
public class Common {
    ...
    public static final String MO_ARTWORKURL = "artworkUrl";
    public static final String MO_COLLECTIONPRICE = "collectionPrice";
    public static final String MO_TRACKS = "tracks";
    public static final String MO_TRACKMAMES = "trackNames";
    public static final String MO_PREVIEWURLS = "previewUrls";
    public static final String MO_TRACKTIMEMILLIS = "trackTimeMillis";
